...
#pragma mark  case 1 可以升级
                 case 1:
                 {
                     ...
                     XHCommonAlertControl *alert = [[XHCommonAlertControl alloc]initWithTitle:@"发现新版本" message:introduceStr delegate:self cancelButtonTitle:@"跳过此版本" otherButtonTitle:@"前方 App Store" withType:XHCommonAlertAppStore];
                     [alert show];
